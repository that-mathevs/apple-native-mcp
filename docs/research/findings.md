...
- [x] **REM-34** [acceptance] given notes, stores them on the reminder and reports whether the store holds notes on it, never the notes themselves (ADR-0006) · NN3 · boutquin `8a5d2e0`; chrischall `6831a90`, `1a358d6`, `b6a4ec6`, `2846497`; long-tail/Heming-Zhong `2dc6104`, `8f4cd41`; long-tail/brunnoaraujo `d8f5f19`; upstream #64, #34
