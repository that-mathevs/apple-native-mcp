...
code parts its words with hyphens, whatever the store it came from: the helper's protocol spells
its own with underscores, and the adapter translates them. A
