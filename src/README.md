...
| `application/<context>/` | one use case per tool operation, and the ports they need | its own domain context |
| `adapters/` | the ways macOS is reached | the ports it implements, and domain types |
